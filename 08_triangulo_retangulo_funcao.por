/*Thiago Soares* - Triângulo retângulo.*/
...
programa {
	...
	funcao inicio() {
		...
		se((hip > cat1)e(hip > cat2)){
		    ...
		    se((hip*hip) == teste){
		        escreva("O triângulo é um triângulo retângulo!\n")
		    }
		    senao{
		       escreva("O triângulo não é um triângulo retângulo!\n") 
		    }
		}
		senao{
		    escreva("Por favor, comece novamente! Você digitou valores em ordem inadequada!")
		}
	}
